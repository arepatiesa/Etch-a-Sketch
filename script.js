...
function resetGrid() {
  //establece el tamaño de la cuadrilla
...
function createGrid(bpz) {
  ...
  for (let i = 0; i < bpz * bpz; i++) {
    //spamea los cubos a lo largo de la cuadrilla
    ...
    div.setAttribute(
      "style",
      "box-sizing: border-box; min-width: 5px; min-height: 5px; border: solid 1px black;"
    );
